  ...
  const isSectionInViewport = () => {
    sections.forEach((sectionId) => {
      ...
      if (section) {
        ...
        // Adjust this condition to match how much of the section needs to be in view (50%, 75%, etc.)
  ...
  return (
    <>
      <div className="pt-[4.75rem] lg:pt-[5.25rem] overflow-hidden animate__animated animate__fadeIn">
        ...
        <Expertise />
        <Features />
        <CTA isOpen={isOpen} toggleModal={toggleModal} isPrivacyOpen={isPrivacyOpen} togglePrivacyModal={togglePrivacyModal} />
        <Footer />
      </div>
      <ButtonGradient />
    </>
